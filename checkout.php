...
<?php 
	...
	if (count($_SESSION['data'])){
			...
			foreach ($_SESSION['data'] as $key => $value) {
				...
				$total_money += calculate($value['type'],$value['to'],$value['from'],$value['date'],$value['hour'],$value['twoman'],"total");
				$total_distance += calculate($value['type'],$value['to'],$value['from'],$value['date'],$value['hour'],$value['twoman'],"distance");
			}
