	...
	<table class="table table-bordered">
		...
		<tbody id="data-cart">
			...
			<tr>				
				...
				<td><?php echo calculate($value['type'],$value['to'],$value['from'],$value['date'],$value['hour'],$value['twoman'],"real") ; ?></td>
				<td><?php echo round(calculate($value['type'],$value['to'],$value['from'],$value['date'],$value['hour'],$value['twoman'],"real")*0.2,2) ; ?></td>
